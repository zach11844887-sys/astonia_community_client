...
DLL_EXPORT char *game_skilldesc[] = {
    ...
    "As you train, your body will become hard and strong, providing you with additional protection from enemy hits; "
    "Body Control helps increase your weapon value too.",
    ...
    "Bless increases all attributes. It will make you more powerful, but only for a limited time. Casting one Bless "
    "spell costs two Mana points.",
    ...
    "received. It costs one Mana point to raise Magic Shield by two.",
    "This spell will either send a Lightning ball, or create lightning flashes to harm your enemies. One Lightning "
    "spell costs three Mana points.",

    "Fire unleashes its energy in an enormous explosion. Cost: three Mana points.", "empty",
    ...
    "Increases speed, has three times the effect of Speed Skill; also reduces endurance cost of fast mode by up to "
    "66%; all classes, base cost 6, maxes at 30.",
    "Capable of making full moon, equinox, and solstice potions at any time (depending on profession level attained); "
    "all classes, base cost 10, maxes at 50.",
    "Increases probability to find silver/gold by 10% per PPS; reduced endurance cost (by PPS*4%); all classes, base "
    "cost 4, maxes at 20.",
    "Gets +1 to attack per PPS when attacking an enemy from the side/behind; if attacking an idle enemy from behind, "
    "gets +3 to attack per PPS, +5 damage per PPS, and backstab; all classes, base cost 10, maxes at 50.",
    "Gets +2 to stealth for each PPS; will remain invisible even when next to another character when walking or idle; "
    "a PK thief can steal from another PK within level limits; all classes, base cost 6, maxes at 30.",
    "Gets +0.5 per PPS to all bases from 6:00 to 18:00; also gets holy vision (ie. can see undead creatures in the "
    "dark but not walls/items/living beings); all classes, base cost 6, maxes at 30.",
    "Gets +0.5 per PPS to all bases from 18:00 to 6:00; also gets infravision (ie. can see other living characters in "
    "the dark but not walls/items/undead); cannot be learned by someone knowing 'Master of Light'; all classes, base "
    "cost 6, maxes at 30.",
    "Bonus (better prices) when buying/selling in shops; all classes, base cost 4, maxes at 20.",
    "PPS*2% more military points from military missions, also gets paid for doing them; all classes, base cost 4, "
    "maxes at 20.",
