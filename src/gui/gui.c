...
DLL_EXPORT int _do_display_help(int nr)
{
	...
	switch (nr) {
	case 1:
		y = dd_drawtext_break(x, y, x + 192, whitecolor, 0, "Help Index");
		y += 15;

		y = dd_drawtext_break(x, y, x + 192, whitecolor, 0, "Fast Help");
		y += 5;
		...
		y = dd_drawtext_break(x, y, x + 192, graycolor, 0, "Assign Wheel Button: Use Wheel");
		y += 10;
	...
	case 2:
		...
		y = dd_drawtext_break(x, y, x + 192, whitecolor, 0, "Accounts");
		y += 5;
		...
		y = dd_drawtext_break(x, y, x + 192, whitecolor, 0, "Account Payments");
		y += 5;
		y = dd_drawtext_break_fmt(x, y, x + 192, graycolor, 0,
		    "If you are having trouble with your account payments, or if you have questions concerning account "
		    "payments, please write %s.",
		    game_email_cash);
		y += 10;

		y = dd_drawtext_break(x, y, x + 192, whitecolor, 0, "Account Sharing");
		y += 5;
		y = dd_drawtext_break(x, y, x + 192, graycolor, 0,
	...
	case 3:
		...
		y = dd_drawtext_break(x, y, x + 192, whitecolor, 0, "Alias commands");
		y += 5;
		y = dd_drawtext_break(x, y, x + 192, graycolor, 0,
	...
	case 4:
		y = dd_drawtext_break(x, y, x + 192, whitecolor, 0, "Banking");
		y += 5;
		y = dd_drawtext_break(x, y, x + 192, graycolor, 0,
		...
		y = dd_drawtext_break(x, y, x + 192, whitecolor, 0, "Base/Mod Values");
		y += 5;
		y = dd_drawtext_break(x, y, x + 192, graycolor, 0,
	...
	case 5:
		...
		y = dd_drawtext_break(x, y, x + 192, whitecolor, 0, "Chat and Channels");
		y += 5;
		y = dd_drawtext_break(x, y, x + 192, graycolor, 0,
		...
		y = dd_drawtext_break(x, y, x + 192, whitecolor, 0, "Clans");
		y += 5;
		y = dd_drawtext_break_fmt(x, y, x + 192, graycolor, 0,
	...
	case 6:
		y = dd_drawtext_break(x, y, x + 192, whitecolor, 0, "Colors");
		y += 5;
		y = dd_drawtext_break(x, y, x + 192, graycolor, 0,
		...
		y = dd_drawtext_break(x, y, x + 192, graycolor, 0,
		    ...
		    "of these commands:  ");
		y += 10;
		y = dd_drawtext_break(x, y, x + 192, graycolor, 0, "/col1 <R><G><B> shirt color");
		y += 5;
		y = dd_drawtext_break(x, y, x + 192, graycolor, 0, "/col2 <R><G><B> pants/skirt/cape color");
		y += 5;
		y = dd_drawtext_break(x, y, x + 192, graycolor, 0, "/col3 <R><G><B> hair/cap color");
		y += 10;
		break;
	case 7:
		y = dd_drawtext_break(x, y, x + 192, whitecolor, 0, "Commands");
		y += 5;
		y = dd_drawtext_break(x, y, x + 192, graycolor, 0,
		...
		y = dd_drawtext_break(x, y, x + 192, whitecolor, 0, "Complains/Harassment");
		y += 5;
		y = dd_drawtext_break(x, y, x + 192, graycolor, 0,
		...
		break;
	case 8:
		y = dd_drawtext_break(x, y, x + 192, whitecolor, 0, "Dying");
		y += 5;
		y = dd_drawtext_break(x, y, x + 192, graycolor, 0,
		    ...
		    "items.");
		y += 10;
		y = dd_drawtext_break(x, y, x + 192, graycolor, 0, "Allowing Access to Your Corpse:");
		y += 5;
		y = dd_drawtext_break(x, y, x + 192, graycolor, 0,
	...
	case 9:
		y = dd_drawtext_break(x, y, x + 192, whitecolor, 0, "Enhancing Equipment");
		y += 5;
		y = dd_drawtext_break(x, y, x + 192, graycolor, 0,
		...
		break;
	case 10:
		y = dd_drawtext_break(x, y, x + 192, whitecolor, 0, "Fighting");
		y += 5;
		y = dd_drawtext_break(x, y, x + 192, graycolor, 0,
		...
		break;
	case 11:
		y = dd_drawtext_break(x, y, x + 192, whitecolor, 0, "Gold");
		y += 5;
		y = dd_drawtext_break(x, y, x + 192, graycolor, 0,
		...
		break;
	case 12:
		y = dd_drawtext_break(x, y, x + 192, whitecolor, 0, "Items");
		y += 5;
		y = dd_drawtext_break(x, y, x + 192, graycolor, 0,
		...
		break;
	case 13:
		y = dd_drawtext_break(x, y, x + 192, whitecolor, 0, "Karma");
		y += 5;
		y = dd_drawtext_break(x, y, x + 192, graycolor, 0,
		...
		break;
	case 14:
		y = dd_drawtext_break(x, y, x + 192, whitecolor, 0, "Leaving the game");
		y += 5;
		y = dd_drawtext_break(x, y, x + 192, graycolor, 0,
		...
		y = dd_drawtext_break(x, y, x + 192, whitecolor, 0, "Light");
		y += 5;
		y = dd_drawtext_break(x, y, x + 192, graycolor, 0,
		...
		y = dd_drawtext_break(x, y, x + 192, whitecolor, 0, "Looking at characters/items");
		y += 5;
		y = dd_drawtext_break(x, y, x + 192, graycolor, 0,
		...
		break;
	case 15:
		y = dd_drawtext_break(x, y, x + 192, whitecolor, 0, "Mirrors");
		y += 5;
		y = dd_drawtext_break(x, y, x + 192, graycolor, 0,
		...
		break;
	case 16:
		y = dd_drawtext_break(x, y, x + 192, whitecolor, 0, "Navigational Directions");
		y += 5;
		y = dd_drawtext_break(x, y, x + 192, graycolor, 0,
		...
		y = dd_drawtext_break(x, y, x + 192, whitecolor, 0, "Negative Experience");
		y += 5;
		y = dd_drawtext_break(x, y, x + 192, graycolor, 0,
		...
		break;
	case 17:
		y = dd_drawtext_break(x, y, x + 192, whitecolor, 0, "Player Killing");
		y += 5;
		y = dd_drawtext_break(x, y, x + 192, graycolor, 0,
		...
		y = dd_drawtext_break(x, y, x + 192, whitecolor, 0, "The Pentagram Quest");
		y += 5;
		y = dd_drawtext_break(x, y, x + 192, graycolor, 0,
		...
		break;
	case 18:
		y = dd_drawtext_break(x, y, x + 192, whitecolor, 0, "Quests");
		y += 5;
		y = dd_drawtext_break(x, y, x + 192, graycolor, 0,
		...
		y += 10;
		y = dd_drawtext_break(x, y, x + 192, whitecolor, 0, "Questions");
		y += 5;
		y = dd_drawtext_break_fmt(x, y, x + 192, graycolor, 0,
	...
	case 19:
		...
		break;
	case 20:
		y = dd_drawtext_break(x, y, x + 192, whitecolor, 0, "Saves");
		y += 5;
		y = dd_drawtext_break(x, y, x + 192, graycolor, 0,
		...
		y = dd_drawtext_break(x, y, x + 192, whitecolor, 0, "Scamming");
		y += 5;
		y = dd_drawtext_break_fmt(x, y, x + 192, graycolor, 0,
	...
	case 21:
		y = dd_drawtext_break(x, y, x + 192, whitecolor, 0, "Shops");
		y += 5;
		y = dd_drawtext_break(x, y, x + 192, graycolor, 0,
		...
		y = dd_drawtext_break(x, y, x + 192, whitecolor, 0, "Skills/Stats");
		y += 5;
		y = dd_drawtext_break(x, y, x + 192, graycolor, 0,
		...
		y = dd_drawtext_break(x, y, x + 192, whitecolor, 0, "Spells");
		y += 5;
		y = dd_drawtext_break(x, y, x + 192, graycolor, 0,
		...
		break;
	case 22:
		y = dd_drawtext_break(x, y, x + 192, whitecolor, 0, "Staffers");
		y += 5;
		y = dd_drawtext_break(x, y, x + 192, graycolor, 0,
		...
		break;
	case 23:
		y = dd_drawtext_break(x, y, x + 192, whitecolor, 0, "Talking");
		y += 5;
		y = dd_drawtext_break(x, y, x + 192, graycolor, 0,
		    "Everything you hear and say is displayed in the chat window at the bottom of your screen.  To talk to a "
		    "character standing next to you, just type what you'd like to say and hit ENTER.  To say something in the "
		...
		y = dd_drawtext_break(x, y, x + 192, whitecolor, 0, "Transport System");
		y += 5;
		y = dd_drawtext_break(x, y, x + 192, graycolor, 0,
		...
		break;
	case 24:
		y = dd_drawtext_break(x, y, x + 192, whitecolor, 0, "Walking");
		y += 5;
		y = dd_drawtext_break(x, y, x + 192, graycolor, 0,
...
display_graphs:
	...
	if (display_vc) {
		...
		dd_drawtext_fmt(px, py += 10, IRGB(8, 31, 8), DD_LEFT | DD_FRAME | DD_NOCACHE, "Mem: %5.2f MB",
		...
		dd_drawtext_fmt(
		    px, py += 10, IRGB(8, 31, 8), DD_NOCACHE | DD_LEFT | DD_FRAME, "Frametime %" PRId64, gui_frametime);
		...
		size = gui_ticktime / 2;
		dd_drawtext_fmt(
		    px, py += 10, IRGB(8, 31, 8), DD_NOCACHE | DD_LEFT | DD_FRAME, "Ticktime %" PRId64, gui_ticktime);
