...
DLL_EXPORT int _is_cut_sprite(unsigned int sprite)
{
	...
	case 20427:
	case 20428: // dungeon walkthrough
	case 20656:
	case 20661:
		return 0;
...
DLL_EXPORT int _is_mov_sprite(unsigned int sprite, int itemhint)
{
	...
	case 20040:
	case 20041:
	case 20042: // wood door
	case 20122:
	case 20123:
	case 20124:
	case 20125: // steel door
	case 20152:
	case 20153:
	case 20154:
	...
	case 20430:
	case 20431:
	case 20432: // dungeon_door
	case 20461:
	case 20462:
	case 20463:
	case 20464: // castlelike_door
	case 20516:
	case 20517:
	case 20518:
	case 20519: // moonie_door
	case 20544:
	case 20545:
	case 20549:
	case 20550: // moonie_prison_door
		return -5;
	case 20664:
	case 20665:
	case 20666:
	case 20667: // grave_large_door // _AA_
	case 20695:
	case 20696:
	case 20697:
	case 20698: // grave_lesssecret_door // _AA_
	case 20699:
	case 20700:
	case 20701:
	case 20702: // grave_lesssecret_door // _AA_
		return -9;
	}
	return itemhint;
}
    ...
    int *pc2, int *pc3, int *pshine, int attick)
{
	...
	case 140:
		...
		scale = 90;
		c3 = 0x001f;
		break; // bearded mage in blue
	case 141:
		csprite = 13;
		scale = 105;
		c3 = 0x03700;
		break; // bearded mage in green
	case 142:
		csprite = 13;
		scale = 95;
		c3 = 0x7c1f;
		break; // bearded mage in purple

	case 143:
		csprite = 4;
		scale = 90;
		c3 = 0x001f;
		break; // merchant in blue
	case 144:
		csprite = 4;
		scale = 105;
		c3 = 0x03700;
		break; // merchant in green
	case 145:
		csprite = 4;
		scale = 95;
		c3 = 0x7c1f;
		break; // merchant in purple
	...
	case 154:
		...
		sat = 10;
		cr = 50;
		break; // earth demon dark brown
	case 155:
		csprite = 29;
		sat = 10;
		cr = 70;
		break; // earth demon light brown
	case 156:
		csprite = 30;
		break; // ratling
	...
	case 200:
		...
		c2 = 0x0300;
		c3 = 0x4108;
		break; // fred, misc merchant, area 1
	case 201:
		csprite = 59;
		c1 = 0x4042;
		c2 = 0x2118;
		c3 = 0x4210;
		break; // talaman, banker, area 1
	case 202:
		csprite = 47;
		c1 = 0x1204;
		c2 = 0x1184;
		c3 = 0x1CE7;
		break; // egbert, armor merchant, area 1
	case 203:
		csprite = 47;
		c1 = 0x2308;
		c2 = 0x4310;
		c3 = 0x3108;
		break; // dolf, weapon merchant, area 1
	case 204:
		csprite = 55;
		c1 = 0x6050;
		c2 = 0x0858;
		c3 = 0x0858;
		break; // nook, jester, area 1
	case 205:
		csprite = 49;
		c1 = 0x3def;
		c2 = 0x294a;
		c3 = 0x5220;
		break; // reskin, barkeep, area 1
	case 206:
		csprite = 52;
		c1 = 0x4980;
		c2 = 0x4a40;
		c3 = 0x0000;
		break; // logain, teach, area 1
	case 207:
		csprite = 54;
		c1 = 0x3def;
		c2 = 0x294a;
		c3 = 0x5220;
		break; // terion, chatter, area 1
	case 208:
		csprite = 49;
		c1 = 0x70e7;
		c2 = 0x4084;
		c3 = 0x730c;
		break; // asturin, thief, area 1
	case 209:
		csprite = 49;
		c1 = 0x2884;
		c2 = 0x2884;
		c3 = 0x1ce7;
		break; // weak thief guard, thief, area 1
	case 210:
		csprite = 49;
		c1 = 0x21c8;
		c2 = 0x4108;
		c3 = 0x59e7;
		break; // guild thief, thief, area 1
	case 211:
		csprite = 49;
		c1 = 0x21c8;
		c2 = 0x4108;
	...
	case 213:
		...
		c2 = 0x739c;
		c3 = 0x1ce7;
		break; // guild assassin, thief, area 1
	case 214:
		csprite = 57;
		c1 = 0x5294;
		c2 = 0x5294;
	...
	case 215:
		...
		c2 = 0x5294;
		c3 = 0x3d47;
		break; // guild master, thief, area 1

	case 216:
		csprite = 43;
		light = 40;
		break; // weak zombie, area 2
	case 217:
		csprite = 43;
		light = 40;
		cr = 10;
	...
	case 218:
		...
		light = 40;
		cb = 10;
		break; // strong zombie, area 2
	case 219:
		csprite = 43;
		light = 40;
		cg = 10;
		break; // superior zombie, area 2
	...
	case 220:
		...
		cg = 20;
		scale = 90;
		break; // weak 'hunter' collector
	case 221:
		csprite = 36;
		light = -10;
		cg = 20;
		scale = 100;
		break; // 'hunter' collector
	case 222:
		csprite = 36;
		light = -10;
		cg = 20;
		scale = 110;
		break; // strong 'hunter' collector

	case 223:
		csprite = 35;
		cg = 10;
		scale = 90;
		break; // weak 'huntress' supervisor
	case 224:
		csprite = 35;
		cg = 10;
		scale = 100;
	...
	case 229:
		...
		c2 = 0x3ca5;
		c3 = 0x5294;
		break; // wesley, banker, area 3
	case 230:
		csprite = 47;
		c1 = 0x5000;
		c2 = 0x3ca5;
		c3 = 0x5294;
		break; // karl, merchant, area 3
	case 231:
		csprite = 47;
		c1 = 0x21e8;
		c2 = 0x1144;
		c3 = 0x1ce7;
		scale = 95;
		break; // ludwig, merchant, area 3
	case 232:
		csprite = 47;
		c1 = 0x3c05;
		c2 = 0x6012;
		c3 = 0x5ad6;
		break; // norbert, merchant, area 3
	case 233:
		csprite = 47;
		c1 = 0x6fb7;
		c2 = 0x2110;
		c3 = 0x5ad6;
		break; // manfred, merchant, area 3
	case 234:
		csprite = 54;
		c1 = 0x6fb7;
		c2 = 0x2110;
		c3 = 0x5ad6;
		break; // jeremy, merchant, area 3
	...
	case 299:
		...
		light = -80;
		shine = 70;
		break; // dark skeleton, random dungeon
	...
	case 309:
		...
		light = -125;
		scale = 120;
		break; // forest: spider queen
	case 310:
		csprite = 40;
		cg = 40;
		light = -10;
		break; // forest: preying mantiss
	case 311:
		csprite = 46;
		c1 = 0x41aa;
		c2 = 0x360a;
	...
	case 316:
		...
		c2 = 0x739c;
		c3 = 0x739c;
		break; // exkordon: governor double
	...
	case 317:
		...
		c2 = 0x18EF;
		c3 = 0x6646;
		break; // exkordon guard with torch
	case 318:
		csprite = 111;
		c1 = 0x4829;
		c2 = 0x18EF;
		c3 = 0x6646;
		break; // exkordon guard

	case 319:
		csprite = 30;
		light = -50;
		cg = 40;
		break; // exkordon ratling
	case 320:
		csprite = 49;
		c1 = 0x2421;
		c2 = 0x3C22;
		c3 = 0x6646;
		break; // exkordon thief guard
	case 321:
		csprite = 49;
		c1 = 0x3031;
		c2 = 0x2837;
	...
	case 322:
		...
		cr = 10;
		scale = 110;
		break; // exkordon statue
	case 323:
		csprite = 41;
		cr = 10;
		scale = 120;
		break; // exkordon statue boss
	case 324:
		csprite = 13;
		c3 = 0x6E82;
		cg = 70;
		light = -10;
		break; // random: wizard of yendor
	case 325:
		csprite = 9;
		cg = 20;
		scale = 110;
		light = -10;
		break; // exkordon: green light skelly
	case 326:
		csprite = 9;
		cr = 20;
		scale = 110;
		light = -10;
		break; // exkordon: red light skelly
	case 327:
		csprite = 9;
		scale = 110;
		light = -10;
		break; // exkordon: no light skelly
	case 328:
		csprite = 21;
		cr = 120;
		cg = 60;
		light = -125;
		break; // exkordon: spider
	case 329:
		csprite = 21;
		cr = 100;
		cg = 80;
	...
	case 332:
		...
		cr = 10;
		shine = 20;
		break; // exkordon: zombie

	case 333:
		csprite = 8;
		shine = 20;
		light = -20;
		break; // bones: skeleton
	case 334:
		csprite = 43;
		light = 30;
		sat = 20;
	...
	case 344:
		...
		c2 = 0x4A55;
		c3 = 0x3421;
		break; // nomad: valkyrie1
	case 345:
		csprite = 48;
		c1 = 0x52DF;
		c2 = 0x4A55;
		c3 = 0x3421;
		break; // nomad: valkyrie2
	...
	case 346:
		...
		c2 = 0x56B5;
		c3 = 0x7FDF;
		break; // nomad: evil monk
	case 347:
		csprite = 34;
		c1 = 0x5C34;
		c2 = 0x3C54;
		c3 = 0x7FDF;
		break; // nomad: sarkilar (monk)
	case 348:
		csprite = 34;
		c1 = 0x7329;
		c2 = 0x6681;
		c3 = 0x7FDF;
		break; // nomad: good monk 1
	case 349:
		csprite = 34;
		c1 = 0x2C39;
		c2 = 0x1CEF;
		c3 = 0x7FDF;
		break; // nomad: good monk 2
	...
	case 351:
		...
		c2 = 0x2014;
		c3 = 0x5E00;
		break; // imperial army seyan male
	case 352:
		csprite = 110;
		c1 = 0x0819;
		c2 = 0x2014;
		c3 = 0x5E00;
		break; // imperial army seyan female

	case 353:
		csprite = 35;
		sat = 20;
		cr = 40;
		break; // strategy, slot1
	case 354:
		csprite = 35;
		sat = 20;
		cg = 40;
		break; // strategy, slot2
	case 355:
		csprite = 35;
		sat = 20;
		cb = 40;
		break; // strategy, slot3
	case 356:
		csprite = 35;
		sat = 20;
		cr = 40;
		cg = 40;
		break; // strategy, slot4

	case 357:
		csprite = 35;
		sat = 20;
		light = 40;
		break; // strategy, neutral worker
	...
	case 409:
		...
		c2 = 0x316B;
		c3 = 0x5568;
		break; // nomad: saltmine gatama
	case 411:
		csprite = 34;
		c1 = 0x6E0C;
		c2 = 0x62B5;
		c3 = 0x5568;
		break; // nomad: saltmine worker
	case 412:
		csprite = 42;
		cr = 40;
		cg = 70;
		cb = 60;
		break; // nomad: saltmine golem made of stone
	...
	case 410:
		...
		c2 = 0x7BBC;
		c3 = 0x5568;
		break; // north: govida        !!! take care of the nr.
	case 413:
		csprite = 48;
		c1 = 0x197A;
		c2 = 0x4A55;
		c3 = 0x3421;
		break; // north: valkyrie blue
	case 414:
		csprite = 48;
		c1 = 0x7063;
		c2 = 0x4A55;
		c3 = 0x3421;
		break; // north: valkyrie red
	case 415:
		csprite = 48;
		c1 = 0x7F28;
		c2 = 0x7F28;
		c3 = 0x7F28;
		break; // north: valkyrie gold
	case 416:
		csprite = 48;
		c1 = 0xFFFF;
		c2 = 0xFFFF;
		c3 = 0xFFFF;
		break; // north: valkyrie white

	case 417:
		csprite = 39;
		scale = 100;
		break; // north: ice deamon
	case 418:
		csprite = 39;
		scale = 103;
		break; // north: ice deamon
	...
	case 569:
		...
		c2 = IRGB(6, 20, 6);
		c3 = IRGB(28, 16, 16);
		break; // bridge guard 1
	case 570:
		csprite = 81;
		c1 = IRGB(16, 31, 16);
		c2 = IRGB(6, 20, 6);
		c3 = IRGB(28, 16, 16);
		break; // bridge guard 2
	case 571:
		csprite = 46;
		c1 = IRGB(31, 16, 16);
		c2 = IRGB(20, 6, 6);
    ...
    unsigned short *pc1, unsigned short *pc2, unsigned short *pc3, unsigned short *pshine)
{
	...
	case 59030:
		sprite = 14257;
		c2 = IRGB(20, 0, 0);
		break; // edemon loader platform red
	case 59031:
		sprite = 14257;
		c2 = IRGB(18, 0, 0);
		break; // edemon loader platform red
	...
	case 59084:
	case 59085:
		sprite = sprite + 21252 - 59082;
		scale = 80;
		break; // weapons decoration
	...
	case 59092:
	case 59093:
		sprite = sprite + 21256 - 59086;
		cr = 40;
		cg = 40;
		light = -10;
		break; // shields decoration
	...
	case 59098:
	case 59099:
		sprite = sprite + 21209 - 59094;
		sat = 10;
		cr = -10;
		cg = -10;
		light = 10;
		cb = 5;
		break; // rich table/chair
	...
	case 59484:
		sprite = 15447;
		break; // copied here so they work as a normal door
	case 59485:
		sprite = 15486;
		break; // copied here so they work as a normal door
	...
	case 59505:
	case 59506:
		sprite = sprite - 59498 + 20636;
		cg = 15;
		light = -40;
		break; // green lighted floor
	...
	case 59511:
	case 59512:
		sprite = sprite - 59507 + 15279;
		cg = 20;
		light = -20;
		break; // green lighted bones

	case 59513:
		sprite = 15432;
		cg = 20;
		light = -20;
		break; // green lighted skelly chair
	case 59514:
		sprite = 15439;
		cg = 20;
		light = -20;
	...
	case 59526:
	case 59527:
		sprite = sprite - 59519 + 20636;
		cr = 15;
		light = -40;
		break; // red lighted floor
	...
	case 59532:
	case 59533:
		sprite = sprite - 59528 + 15279;
		cr = 20;
		light = -20;
		break; // red lighted bones

	case 59534:
		sprite = 15432;
		cr = 20;
		light = -20;
		break; // red lighted skelly chair
	case 59535:
		sprite = 15439;
		cr = 20;
		light = -20;
		break; // empty red lighted skelly chair
	...
	case 59543:
	case 59544:
		sprite = sprite - 59536 + 20636;
		light = -40;
		break; // unlighted floor

	case 59545:
	case 59546:
		sprite = sprite - 59545 + 20122;
		sat = 20;
		cg = 60;
		light = 20;
		shine = 30;
	...
	case 59551:
		sprite = 15432;
		break; // nolight skelly chair
	case 59552:
		sprite = 15439;
		break; // empty nolight skelly chair
	case 59553:
		sprite = 20779;
		light = 70;
		shine = 70;
	...
	case 59561:
	case 59562:
		sprite = sprite + 20300 - 59554;
		light = -50;
		cr = 15;
		break; // dark orange sand ground
	...
	case 59569:
	case 59570:
		sprite = sprite + 14030 - 59563;
		light = -50;
		cr = 30;
		cg = 10;
		break; // dark orange stone walls

	case 59571:
	case 59572:
	case 59573:
	case 59574:
		sprite = sprite + 20272 - 59571;
		c1 = IRGB(20, 8, 0);
		break;
	...
	case 60002:
	case 60003:
	case 60004: // white berries
	case 60005:
	case 60006:
	case 60007:
	case 60008:
	case 60009: // white berries
	case 60010:
	case 60011:
	case 60012:
	case 60013:
	case 60014: // white berries
		sprite = 11020 + (sprite - 60000);
		sat = 10;
		light = 125;
		scale = 70;
		break;
	...
	case 60017:
	case 60018:
	case 60019: // norther land wallset
	case 60020:
	case 60021:
	case 60022:
	case 60023:
